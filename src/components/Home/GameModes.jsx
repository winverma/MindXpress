...
const gameModes = [
	...
	},
	{
		...
		title: 'Time',
		description: 'Complete questions within the time limit to win! Once again, You can use wildcards!'
	},
	{
		icon: <ImInfinite className='text-3xl' />,
		title: 'Infinite',
		description: 'Break your record by completing as many questions as you can!'
	}
]
...
export default function GameModes () {
	return (
		<section className='lg:max-w-6xl mx-auto lg:col-start-1 lg:col-end-2 px-8 py-6 flex flex-col justify-center bg-[url("/bg-gamemodes.svg")] text-slate-900 w-full'>
			<h2 className='text-3xl mb-2 font-medium' style={{ color: 'black' }}>Game Modes</h2>
			<nav>
